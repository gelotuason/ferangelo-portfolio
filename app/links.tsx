...
export function LetsTalk() {
    return (
        <Link href='../contact' className="flex gap-[8px] mt-[32px] bg-blue-700 w-full lg:w-[140px] items-center justify-center p-[16px] rounded-xl text-white shadow-lg shadow-blue-700/50 animate-bounce">
